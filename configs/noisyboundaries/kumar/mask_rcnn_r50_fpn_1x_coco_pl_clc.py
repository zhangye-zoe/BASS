...
_base_ = [
    ...
    '../../_base_/datasets/kumar_instance_pl.py',
...
data=dict(
    train = dict(
        ...
        datasets=[
           ...
           dict(type=dataset_type,
                ann_file='/data4/zhangye/noisyboundaries/labels/kumar_1_2_pl.json',
                ann_dir = "/data4/zhangye/noisyboundaries/data/Kumar/train/mask",
                inst_suffix = '.npy',
                img_prefix=data_root + 'train/patch',
                pipeline=train_pipeline),
    ...
    test=dict(
        ...
        ann_dir = "/data4/zhangye/noisyboundaries/data/Kumar/test/mask",
        inst_suffix = '.npy',
        pipeline=test_pipeline,
        base_set='nonvoc',
        novel_set='voc'),
